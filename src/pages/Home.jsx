    ...
    <>
      ...
      <main>
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 p-5 md:p-10 max-w-4xl mx-auto">
          <div className="flex flex-col items-center text-center md:items-start md:text-left space-y-3 max-w-2xl">
           <h1 className="text-3xl md:text-5xl font-normal">Gabriel Siqueira</h1>
           <p className="text-lg md:text-2xl">Engenheiro de Software</p>
           <p>
            ...
            <div className="flex flex-wrap justify-center mt-5 gap-4 md:gap-6">
              <MyButton>
                <a
                  href="https://github.com/Gabrielvsiqueira/My-Resume/releases/latest/download/curriculum.pdf"
                  target="_blank"
                >
                Resume
                </a>
